...
local key = Menu.AddKeyOption({"Utility"}, "CreepBlock TU", Enum.ButtonCode.KEY_SPACE)
Blocker.skipRangedCreep = Menu.AddOption({ "Utility", "[CB] Skip ranged creep" }, "Enabled", "Bot will try to skip ranged creep.")
